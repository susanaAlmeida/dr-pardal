/*
	Rollup.js v0.26.2
	Tue May 03 2016 09:21:03 GMT-0400 (EDT) - commit b616db1b6b170dd5cb8e8ae62e005e00278525ba
...
var Parser = function Parser(options, input, startPos) {
  ...
  var reserved = options.allowReserved ? "" :
      reservedWords$1[options.ecmaVersion] + (options.sourceType == "module" ? " await" : "")
...
pp$1.parseForStatement = function(node) {
  ...
  if (this.type === tt._var || this.type === tt._let || this.type === tt._const) {
    var init$1 = this.startNode(), varKind = this.type
    this.next()
    this.parseVar(init$1, true, varKind)
    this.finishNode(init$1, "VariableDeclaration")
    if ((this.type === tt._in || (this.options.ecmaVersion >= 6 && this.isContextual("of"))) && init$1.declarations.length === 1 &&
        !(varKind !== tt._var && init$1.declarations[0].init))
  ...
  for (var cur, sawDefault = false; this$1.type != tt.braceR;) {
    if (this$1.type === tt._case || this$1.type === tt._default) {
      ...
      if (isCase) {
        ...
        if (sawDefault) this$1.raise(this$1.lastTokStart, "Multiple default clauses")
        sawDefault = true
        cur.test = null
      }
...
pp$1.parseVar = function(node, isFor, kind) {
  ...
  for (;;) {
    ...
    } else if (kind === tt._const && !(this$1.type === tt._in || (this$1.options.ecmaVersion >= 6 && this$1.isContextual("of")))) {
      this$1.unexpected()
  ...
  while (!this$1.eat(tt.braceR)) {
    ...
    if (isGetSet) {
      ...
      if (method.value.params.length !== paramCount) {
        ...
        if (method.kind === "get")
          this$1.raise(start, "getter should have no params");
        else
          this$1.raise(start, "setter should have exactly one param")
      }
...
pp$3.parseExprList = function(close, allowTrailingComma, allowEmpty, refDestructuringErrors) {
  ...
  while (!this$1.eat(close)) {
    if (!first) {
      this$1.expect(tt.comma)
      if (this$1.type === close && refDestructuringErrors && !refDestructuringErrors.trailingComma) {
...
pp$3.parseComprehension = function(node, isGenerator) {
  ...
  node.blocks = []
  while (this$1.type === tt._for) {
    var block = this$1.startNode()
    this$1.next()
    this$1.expect(tt.parenL)
    block.left = this$1.parseBindingAtom()
    this$1.checkLVal(block.left, true)
    this$1.expectContextual("of")
    block.right = this$1.parseExpression()
    this$1.expect(tt.parenR)
    node.blocks.push(this$1.finishNode(block, "ComprehensionBlock"))
  }
